                                                                ...
                                                                <tr>
                                                                    <td width="540" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="right" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img src="https://vovzkd.stripocdn.email/content/guids/CABINET_a33291f2d8bcb53b81694acefe7a4a0f/images/lsd79tjf_400x400.jpeg" alt style="display: block;" width="530"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b">
                                                                                        <h1>Estimado Consumidor(a)</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b">
                                                                                        <p style="text-align: justify;">La Dirección de Atención y Asistencia al Consumidor -DIACO-, le informa que se ha comenzado el proceso de revisión de su queja por parte del personal de DIACO.<br><br></p>
                                                                                        <ul>
                                                                                            <li style="text-align: justify;">
                                                                                                <p><strong>Descripción:</strong> {{ $descripcion }}<br></p>
                                                                                            </li>
                                                                                            <li style="text-align: justify;">
