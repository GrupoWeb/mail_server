                                                                ...
                                                                <tr>
                                                                    <td width="540" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img src="https://vovzkd.stripocdn.email/content/guids/CABINET_4709ae2f4f435cbba1353daba266477f/images/mineco02.png" alt style="display: block;" width="470"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10b">
                                                                                        <h1>Estimado Usuario: {{ $usuario_to }}</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b">
                                                                                        <p><span style="background-color: transparent;">Se te ha sido asignado un documento que contiene la siguiente información:</span></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text">
                                                                                        <ul>
                                                                                            <li>
                                                                                                <p><strong>Empresa:</strong> {{ $empresa_to}}</p>
                                                                                            </li>
                                                                                            <li>
                                                                                                <p><strong>Correlativo:</strong> {{ $numero_to}}</p>
                                                                                            </li>
                                                                                            <li>
                                                                                                <p><strong>Correlativo Interno: </strong>{{ $interno}}</p>
                                                                                            </li>
                                                                                            <li>
                                                                                                <p><strong>Asunto:</strong> {{ $asunto_to}}</p>
                                                                                            </li>
                                                                                            <li>
                                                                                                <p><strong>Con copia a:</strong></p>
                                                                                                <br>
                                                                                            ...
                                                                                            <li>
                                                                                                <p><strong>Instrucción:</strong>{{ $instrucciones }}<br></p>
                                                                                            </li>
                                                                                            <li>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b" esd-links-color="#1d367c">
                                                                                        <p>Entra al panel del Sistema de Documentos y Acepta la Recepción<br><br><a target="_blank" href="https://documentos.mineco.gob.gt" style="color: #1d367c;">Click Aqui....</a></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b">
                                                                                        <p><span style="background-color: transparent;">Atentamente.<br>Sistema de Documentos -MINECO-</span></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
